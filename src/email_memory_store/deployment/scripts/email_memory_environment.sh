...
if [[ "${EMAIL_MEMORY_TEST_MODE:-0}" == '1' ]]; then
  ...
  EMAIL_MEMORY_STORE_CONTROL_MCP_COMMAND="${EMAIL_MEMORY_STORE_CONTROL_MCP_COMMAND:-${EMAIL_MEMORY_STORE_ENVIRONMENT}/bin/email-memory-store-control-mcp}"
  ...
  EMAIL_MEMORY_STORE_CONTROL_MCP_COMMAND="${EMAIL_MEMORY_STORE_ENVIRONMENT}/bin/email-memory-store-control-mcp"
  ...
  for required_binary in \
    ...
    "$EMAIL_MEMORY_STORE_MCP_COMMAND" \
    "$EMAIL_MEMORY_STORE_CONTROL_MCP_COMMAND"; do
    resolved_binary=''
...
export EMAIL_MEMORY_STORE_CONTROL_MCP_COMMAND
