...
class EmailMemoryPaths:
    ...
    def from_root(
        ...
        return cls(
            root=root_path,
            db_path=root_path / 'email_memory.duckdb',
            entity_db_path=root_path / 'entity_memory.duckdb',
            ...
            work_db_path=(work_root_path / 'email_memory.work.duckdb') if work_root_path else None,
        )
